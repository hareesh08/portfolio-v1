...
const BackgroundAnimation = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {/* Gradient orbs - forest green theme */}
      <div className={`absolute top-0 left-0 w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-emerald-500/[0.03] rounded-full ${isMobile ? 'blur-xl' : 'blur-2xl'} bg-orb`} />
      <div className={`absolute top-1/3 right-0 w-[250px] md:w-[350px] h-[250px] md:h-[350px] bg-teal-500/[0.02] rounded-full ${isMobile ? 'blur-xl' : 'blur-2xl'} bg-orb`} style={{ animationDelay: '2s' }} />
      <div className={`absolute bottom-0 left-1/4 w-[350px] md:w-[500px] h-[350px] md:h-[500px] bg-emerald-500/[0.02] rounded-full ${isMobile ? 'blur-xl' : 'blur-2xl'} bg-orb`} style={{ animationDelay: '4s' }} />
      
      {/* Floating particles - forest green theme */}
      {!isMobile && (
